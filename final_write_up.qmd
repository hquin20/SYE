...
+ \text{ } \beta_9 \cdot \text{Documentary} + \beta_{10} \cdot \text{Drama} + \beta_{11} \cdot \text{Family} + \beta_{12} \cdot \text{Fantasy} \\
+ \text{ } \beta_{13} \cdot \text{History} + \beta_{14} \cdot \text{Horror} + \beta_{15} \cdot \text{Music} + \beta_{16} \cdot \text{Musical} \\
+ \text{ } \beta_{17} \cdot \text{Mystery} + \beta_{18} \cdot \text{Romance} + \beta_{19} \cdot \text{Short} + \beta_{20} \cdot \text{Sport} \\
+ \text{ } \beta_{21} \cdot \text{Thriller} + \beta_{22} \cdot \text{War} + \beta_{23} \cdot \text{Western} \\
+ \text{ } \beta_{24} \cdot \text{Year:Animation} + \beta_{25} \cdot \text{Year:Action} + \beta_{26} \cdot \text{Year:Adult} \\
+ \text{ } \beta_{27} \cdot \text{Year:Adventure} + \beta_{28} \cdot \text{Year:Biography} + \beta_{29} \cdot \text{Year:Comedy} \\
+ \text{ } \beta_{30} \cdot \text{Year:Crime} + \beta_{31} \cdot \text{Year:Documentary} + \beta_{32} \cdot \text{Year:Drama} \\
+ \text{ } \beta_{33} \cdot \text{Year:Family} + \beta_{34} \cdot \text{Year:Fantasy} + \beta_{35} \cdot \text{Year:History} \\
+ \text{ } \beta_{36} \cdot \text{Year:Horror} + \beta_{37} \cdot \text{Year:Music} + \beta_{38} \cdot \text{Year:Musical} \\
+ \text{ } \beta_{39} \cdot \text{Year:Mystery} + \beta_{40} \cdot \text{Year:Romance} + \beta_{41} \cdot \text{Year:Short} \\
+ \text{ } \beta_{42} \cdot \text{Year:Sport} + \beta_{43} \cdot \text{Year:Thriller} + \beta_{44} \cdot \text{Year:War} + \beta_{45} \cdot \text{Year:Western}
$$
...
```{r}
genre_model |> pander::pander(caption = "Model Coefficients")
```
...
```{r}
mod_year |> pander::pander(caption = "Model Coefficients")
```
