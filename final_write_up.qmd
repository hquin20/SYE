...
The last predictor in this model is year, predicting that as the release year increases by 1, the log odds of passing the test increase by 0.0161 as other variables are held constant. This demonstrates that newer movies are more likely to pass the test than older movies.
