...
ggplot(rug_plots, mapping = aes(x = year, y = binary)) +
  geom_rug(data = rug_plots.pass, sides = "t") +
  geom_rug(data = rug_plots.fail, sides = "b") +
  geom_smooth(method = "glm", method.args = list(family = "binomial"), se = F)   ## cannot get this to work !!
